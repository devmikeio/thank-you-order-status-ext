...
${errorInfo.componentStack}`);
  ...
  // extensions/thank-you-order-status-tutorial/src/Checkout.tsx
  var import_react11 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var thankYouBlock = reactExtension(
    "purchase.thank-you.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {})
  );
  var orderStatusBlock = reactExtension(
  ...
  function Extension() {
    ...
    const [checkoutMessage, setCheckoutMessage] = (0, import_react11.useState)(null);
    (0, import_react11.useEffect)(() => {
      function getProductCheckoutMessage() {
        return __async(this, null, function* () {
    ...
    if (!checkoutMessage)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "small", children: checkoutMessage });
  }
})();
//# sourceMappingURL=thank-you-order-status.js.map
